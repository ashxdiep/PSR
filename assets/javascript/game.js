// Initialize Firebase
var config = {
  apiKey: "AIzaSyDNqMwJoT9jy49ZaE2k6nZPALMOfro-ZEM",
  authDomain: "snargivore.firebaseapp.com",
  databaseURL: "https://snargivore.firebaseio.com",
  projectId: "snargivore",
  storageBucket: "snargivore.appspot.com",
  messagingSenderId: "950121511427"
};
...
//else the green light is on
  ...
  alert("Someone is currently playing. Wait until the light is no longer green");
}
});
...
database.ref("/firechat").on("value", function(snapshot) {
  ...
  var pic = "<img src = './assets/images/favatar .png' >";
...
database.ref("/icechat").on("value", function(snapshot) {
  ...
  var pic = "<img src = './assets/images/iavatar.png' >";
...
function displayMove(fmove, imove){
  ...
  //for fireman
    ...
    if (fmove === "rock"){
      $(".fhands").empty();
      $(".fhands").append("<img src = './assets/images/firelord.png' >");
      $(".fhands").append("<img src = './assets/images/firerhand.png'>");
    }
    //else if f move is paper append paper hand to html
    else if (fmove === "paper") {
      $(".fhands").empty();
      $(".fhands").append("<img src = './assets/images/firelord.png'  >");
      $(".fhands").append("<img src = './assets/images/firephand.png'>");
    ...
    //else, append scissors hand to html
      ...
      $(".fhands").empty();
      $(".fhands").append("<img src = './assets/images/firelord.png'  >");
      $(".fhands").append("<img src = './assets/images/fireshand.png'>");
    }
  ...
  //for imove
    ...
    if (imove === "rock"){
      $(".ihands").empty();
      $(".ihands").prepend("<img src = './assets/images/icerhand.png'>");
      $(".ihands").append("<img src = './assets/images/icequeen.png'  >");
    }
    //else if imove is paper append paper hand to html
    else if (imove === "paper"){
      $(".ihands").empty();
      $(".ihands").prepend("<img src = './assets/images/icephand.png'>");
      $(".ihands").append("<img src = './assets/images/icequeen.png' id = 'iqueen' style = 'float :right;' >");
    }
    //else , append scissor hand to html
    else{
      $(".ihands").empty();
      $(".ihands").prepend("<img src = './assets/images/iceshand.png'>");
      $(".ihands").append("<img src = './assets/images/icequeen.png' id = 'iqueen' style = 'float :right;' >");
    }
}
...
function playGame(fchoice,ichoice){
    ...
    if (((fchoice === "scissors") && (ichoice ==="paper")) || (fchoice === "rock") && (ichoice ==="scissors") || (fchoice === "paper") && (ichoice ==="rock")){
      $(".fhands").empty();
      $(".fhands").append("<img src = './assets/images/firelord.png'  >");
      $(".fhands").append("<img src = './assets/images/ftalk.png'>");
      firewins++;
      return "firelord";
    }
    ...
    //ice winning combinations
      ...
      $(".ihands").empty();
      $(".ihands").append("<img src = './assets/images/icequeen.png' id = 'iqueen' style = 'float :right;' >");
      $(".ihands").prepend("<img src = './assets/images/italk.png'>");
      icewins++;
      return "icequeen";
    }
 ...
 if (winner === "firelord"){
    ...
    //else
      ...
      for (var i = 0; i < firewins; i++){
        $(".fstars").append("<img src = './assets/images/star.png'>");
      }
    }
  }
  ...
  //if winner is icequeen
    ...
    //else
      ...
      for (var k = 0; k < icewins; k++){
        $(".istars").append("<img src = './assets/images/star.png'>");
      }
    }
  }
